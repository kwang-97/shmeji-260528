import { D as DOMAdapter, T as Texture, h as Color, M as Matrix, l as FillPattern, F as FillGradient, at as warn, E as EventEmitter, aq as uid, r as GraphicsContext, ao as toFillStyle, ap as toStrokeStyle, a5 as deprecation, as as v8_0_0, L as TextureStyle, R as Rectangle, I as ImageSource, f as Cache, ag as groupD8 } from "./index-DQZvRS8p.js";
...
function getCanvasFillStyle(fillStyle, context, textMetrics, padding = 0, offsetX = 0, offsetY = 0) {
  if (fillStyle.texture === Texture.WHITE && !fillStyle.fill) {
    ...
    fillGradient.textureSpace === "local";
    let width = 1;
    let height = 1;
    let gradient;
    if (isLinear) {
